...
<tr>
<td class="tl">APP二维码</td>
<td><input name="setting[app]" type="text" value="<?php echo $app;?>" id="app" size="58"/> <span onclick="Dthumb(1,120,141, Dd('app').value, 0, 'app');" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="Dd('app').value='';" class="jt">[删除]</span></td>
</tr>
<tr>
<td class="tl">公众号二维码</td>
<td><input name="setting[wechat]" type="text" value="<?php echo $wechat;?>" id="wechat" size="58"/> <span onclick="Dthumb(1,120,141, Dd('wechat').value, 0, 'wechat');" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="Dd('logo').value='';" class="jt">[删除]</span></td>
</tr>
<!--
<tr>
<td class="tl">交易流程</td>
<td><input name="setting[liucheng]" type="text" value="<?php echo $liucheng;?>" id="liucheng" size="58"/> <span onclick="Dthumb(1,1180,205, Dd('liucheng').value, 0, 'liucheng');" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="Dd('logo').value='';" class="jt">[删除]</span></td>
</tr>
--->
<tr>
<td class="tl">版权信息</td>
...
<tr>
<td class="tl">客服姓名</td>
<td><input name="setting[kfname]" type="text" value="<?php echo $kfname;?>" size="20"/></td>
</tr>
<tr>
<td class="tl">客服手机</td>
<td><input name="setting[mobile]" type="text" value="<?php echo $mobile;?>" size="20"/></td>
</tr>
<tr>
...
<tr>
	<td class="tl">今日成交</td>
	<td><input name="setting[data_jrcj]" type="text" value="<?php echo $data_jrcj;?>" />单</td>
</tr>
<tr>
	<td class="tl">应标</td>
	<td><input name="setting[data_yb]" type="text" value="<?php echo $data_yb;?>" />单</td>
</tr>
<tr>
	<td class="tl">中标</td>
	<td><input name="setting[data_zhb]" type="text" value="<?php echo $data_zhb;?>" />单</td>
</tr>
<tr>
	<td class="tl">入驻</td>
	<td><input name="setting[data_rzh]" type="text" value="<?php echo $data_rzh;?>" />单</td>
</tr>
<tr>
	<td class="tl">代理商需求</td>
	<td><input name="setting[data_dls]" type="text" value="<?php echo $data_dls;?>" />单</td>
</tr>
<tr>
	<td class="tl">加盟需求</td>
	<td><input name="setting[data_jm]" type="text" value="<?php echo $data_jm;?>" />单</td>
</tr>
<tr>
	<td class="tl">兼职需求</td>
	<td><input name="setting[data_jzh]" type="text" value="<?php echo $data_jzh;?>" />单</td>
</tr>
