...
<?php } } ?>
    ...
    <div class="Navigation">
        ...
        <div class="container">
            <div class="uk-grid">
<?php echo tag("moduleid=$moduleid&condition=status=3&areaid=$cityid&order=".$MOD['order']."&pagesize=2&target=_blank&template=list-hl");?>
                <div class="uk-width-1-5 uk-delimit-white Label" style="margin-left:10px">
                    <h6 class="uk-text-delimit-gray uk-margin-top">文章标签</h6>
                    <div class="uk-grid  uk-grid-collapse uk-delimit-goble-padding">
...
<?php } } ?>
    ...
    <div class="header">
        <div class="container">
            <div class="nav">
                <ul>
                    <li><a href='<?php echo $MOD['linkurl'];?>'>最新</a><span></span></li>
                </ul>
            </div>
        </div>
    </div>
