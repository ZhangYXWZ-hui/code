...
<dt>区域</dt>
<dd>
<div><a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('search.php?areaid=0&catid='.$catid.'&day='.$day);?>"  <?php if($areaid=='') { ?> class="curr"<?php } ?>
>不限</a></div>
<?php $mainarea = get_mainarea(0)?>
<?php if(is_array($mainarea)) { foreach($mainarea as $k => $v) { ?>
<div><a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('search.php?areaid='.$v[areaid].'&catid='.$catid.'&day='.$day.'&qudao='.$qudao);?>" <?php if($v['areaid']==$areaid) { ?> class="curr"<?php } ?>
...
<dt>渠道</dt>
<dd>
<div><a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('search.php?qudao=&catid='.$catid.'&areaid='.$areaid.'&day='.$day);?>" <?php if($qudao =='') { ?> class="curr"<?php } ?>
>不限</a></div>
<?php if(is_array($qudaoList)) { foreach($qudaoList as $k => $v) { ?>
<div><a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('search.php?qudao='.$v[0].'&catid='.$catid.'&areaid='.$areaid.'&day='.$day);?>" <?php if($qudao==$v['0']) { ?>class="curr"<?php } ?>
><?php echo $v['1'];?></a></div>
<?php } } ?>
</dd>
</dl>
...
<dt>时间</dt>
<dd>
<div><a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('search.php?day=0&catid='.$catid.'&areaid='.$areaid.'&qudao='.$qudao);?>" <?php if($day ==0) { ?> class="curr"<?php } ?>
>不限</a></div>
<div><a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('search.php?day=1&catid='.$catid.'&areaid='.$areaid.'&qudao='.$qudao);?>" <?php if($day ==1) { ?> class="curr"<?php } ?>
>今天</a></div>
<div><a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('search.php?day=2&catid='.$catid.'&areaid='.$areaid.'&qudao='.$qudao);?>" <?php if($day ==2) { ?> class="curr"<?php } ?>
>昨天</a></div>
<div><a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('search.php?day=7&catid='.$catid.'&areaid='.$areaid.'&qudao='.$qudao);?>" <?php if($day ==7) { ?> class="curr"<?php } ?>
>7天内</a></div>
<div><a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('search.php?day=15&catid='.$catid.'&areaid='.$areaid.'&qudao='.$qudao);?>" <?php if($day ==15) { ?> class="curr"<?php } ?>
>15天内</a></div>
<div><a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('search.php?day=30&catid='.$catid.'&areaid='.$areaid.'&qudao='.$qudao);?>" <?php if($day ==30) { ?> class="curr"<?php } ?>
>30天内</a></div>
<div><a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('search.php?day=60&catid='.$catid.'&areaid='.$areaid.'&qudao='.$qudao);?>" <?php if($day ==60) { ?> class="curr"<?php } ?>
>2月内</a></div>
</dd>
</dl>
</div>
<div  class="info">
<div  class="search">
为您找到 <em><?php echo $items;?></em> 相关项目
</div>
<div  class="sort">
...
<?php if($page>1) { ?><?php echo $MOD['linkurl'];?><?php echo rewrite('list.php?catid='.$catid.'&page='.($page+1));?><?php } else { ?>#<?php } ?>
">></a></div>
...
<div id="" class="left">
<div id="" class="title">
<span>[意向]</span><a href="<?php echo $t['linkurl'];?>" target="_blank" title="<?php echo $t['alt'];?>"><?php echo $t['title'];?></a></div>
<div id="" class="tag">
<ul>
...
<li class="vip mt5">
<?php if($_money>$t['fee']) { ?>
<a href="JavaScript:;"><span>联系方式:</span><?php echo $t['mobiles'];?></a>
<?php } else { ?>
