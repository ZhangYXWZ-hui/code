...
<div  class="info">
<div  class="search">
为您找到 <em>2604624</em> <!--<em><?php echo $items;?></em>-->相关创业者
</div>
<div  class="sort">
...
<div  class="page mr">第<?php echo $page;?>/<?php echo (round($items/$pagesize)+1);?>页&nbsp;&nbsp;&nbsp;&nbsp;<a class="uk-button" href="#">></a></div>
...
<div id="" class="left">
<div id="" class="title">
<span>[意向]</span><a href="<?php echo $t['linkurl'];?>" target="_blank" title="<?php echo $t['alt'];?>"><?php echo $t['title'];?></a>
