...
<div><a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('search.php?areaid='.$v[areaid].'&catid='.$catid.'&day='.$day);?>" <?php if($v['areaid']==$areaid) { ?> class="curr"<?php } ?>
...
<dt>时间</dt>
<dd>
<div><a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('search.php?day=0&catid='.$catid.'&areaid='.$areaid);?>" <?php if($day ==0) { ?> class="curr"<?php } ?>
>不限</a></div>
<div><a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('search.php?day=1&catid='.$catid.'&areaid='.$areaid);?>" <?php if($day ==1) { ?> class="curr"<?php } ?>
>今天</a></div>
<div><a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('search.php?day=2&catid='.$catid.'&areaid='.$areaid);?>" <?php if($day ==2) { ?> class="curr"<?php } ?>
>昨天</a></div>
<div><a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('search.php?day=7&catid='.$catid.'&areaid='.$areaid);?>" <?php if($day ==7) { ?> class="curr"<?php } ?>
>7天内</a></div>
<div><a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('search.php?day=15&catid='.$catid.'&areaid='.$areaid);?>" <?php if($day ==15) { ?> class="curr"<?php } ?>
>15天内</a></div>
<div><a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('search.php?day=30&catid='.$catid.'&areaid='.$areaid);?>" <?php if($day ==30) { ?> class="curr"<?php } ?>
>30天内</a></div>
<div><a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('search.php?day=60&catid='.$catid.'&areaid='.$areaid);?>" <?php if($day ==60) { ?> class="curr"<?php } ?>
>2月内</a></div>
</dd>
</dl>
</div>
...
<span>[意向]</span>&nbsp;&nbsp;
<?php if($_groupid != 7) { ?>
<a href="#modal" data-uk-modal="{center:true}"><?php echo $t['title'];?></a>
<?php } else { ?>
