...
<?php if($action == 'register_success') { ?>
<div style="background:url('<?php echo DT_STATIC;?><?php echo $MODULE['2']['moduledir'];?>/image/okay.gif') no-repeat 0 25px;font-size:16px;font-weight:bold;color:#4FA800;padding:30px 0 30px 40px;margin:0 0 0 100px;">恭喜您！会员注册成功，正在登录系统...</div>
