...
<div class="b10"> </div>
<div class="box_head"><div><span class="f_r"><a href="<?php echo $MODULE['4']['linkurl'];?><?php echo rewrite('search.php?vip=1');?>">更多&raquo;</a></span><strong>最新<?php echo VIP;?></strong></div></div>
