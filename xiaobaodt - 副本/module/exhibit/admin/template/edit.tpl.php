...
<tr>
<td class="tl"><span class="f_red">*</span> 所属行业分类</td>
<td><?php echo category_select('post[catid]', '选择行业分类', $catid, $moduleid);?> <span id="dcatid" class="f_red"></span></td>
</tr>
<tr>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 主办单位</td>
